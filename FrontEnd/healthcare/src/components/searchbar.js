  ...
  return (
    <section  className="section is-searchbar py-4 flex items-center justify-center mt-[10vh]">
        <div className="searchbar-component h-12 max-w-5xl w-full px-8">
            <input className="searchbar-field w-4/5 outline-2 h-full px-4 rounded-lg rounded-r-none border-solid border-black border placeholder-gray-400" placeholder="Search doctors, therapies, nurse services, hospitals, location" />

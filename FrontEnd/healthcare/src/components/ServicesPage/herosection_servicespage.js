...
import servicesHeroImage from '../Images/serviceshero.jpg'
  ...
  return (
    <section className='section is-serviceshero px-24 py-8 flex '>
        ...
        <div className="hero-right-container w-1/2 h-full py-24 px-16 flex flex-col items-center">
            ...
            <Link to="/Help"><button className='mt-8 px-6 py-4 text-white rounded-lg text-xl bg-whistler-blue font-inter font-bold hover:bg-whistler-green hover:scale-105'>Talk to an Expert</button></Link>
        </div>
    </section>
  );
}

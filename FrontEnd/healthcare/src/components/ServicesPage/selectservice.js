...
import doctorServiceImage from '../Images/doctor.jpg'
            ...
            <div className='flex justify-between w-full gap-28'>
                ...
                <div className='services-card w-full h-[70vh] rounded-3xl overflow-hidden'>
                    ...
                    <div className='h-2/5 bg-gredient-green flex flex-col justify-between px-10 py-10 items-center'>
                        ...
                        <Link to="/selectTherapy"><button className='mt-8 px-6 py-4 bg-whistler-blue text-white rounded-lg font-semibold font-inter flex-shrink-0 hover:bg-whistler-green hover:scale-105'>View Therapies</button></Link>
                    </div>
                </div>
                <div className='services-card w-full h-[70vh] rounded-3xl overflow-hidden'>
                    ...
                    <div className='h-2/5 bg-gredient-green flex flex-col justify-between px-10 py-10 items-center'>
                        ...
                        <Link to="/selectNurse"><button className='mt-8 px-6 py-4 bg-whistler-blue text-white rounded-lg font-semibold font-inter flex-shrink-0 hover:bg-whistler-green hover:scale-105'>View Nurse Care</button></Link>
                    </div>
                </div>
            </div>
    </section>

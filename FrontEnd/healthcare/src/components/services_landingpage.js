...
function ServicesSection() {
  return (
    <section className='section is-services flex flex-col gap-16 py-8 px-44'>
        ...
        <div className="Service-card flex w-full rounded-3xl overflow-hidden shadow-lg">
            <div className='w-1/2 h-full bg-red-200 p-12 text-center bg-gradient-to-b from-gredient-green to-white'>
                ...
                <button className='mt-8 px-6 py-4 bg-whistler-blue text-white rounded-lg font-semibold font-inter flex-shrink-0 hover:bg-whistler-green hover:scale-105'>Book A Therapy</button>
            </div>
        ...
        <div className="Service-card flex  w-full rounded-3xl overflow-hidden shadow-lg">
            ...
            <div className='w-1/2 h-full bg-gradient-to-b from-gredient-green to-white p-12 text-center rounded-3xl rounded-l-none'>
                ...
                <button className='mt-8 px-6 py-4 bg-whistler-blue text-white rounded-lg font-semibold font-inter flex-shrink-0 hover:bg-whistler-green hover:scale-105'>Book A Nurse Care</button>
            </div>
        </div>
    </section>
  );

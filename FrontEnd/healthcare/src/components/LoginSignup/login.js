                ...
                <form onSubmit={handleLogin}>
                    <div className='px-36 py-4 flex gap-16 '>
                        ...
                        <div className="login-right-container w-1/2 h-full py-16 px-16 flex flex-col items-start bg-gray-50 shadow-2xl rounded-xl">
                            <h2 className='text-xl w-full text-center font-semibold mb-12 font-inter text-whistler-blue'>Enter Your Credentials to Login</h2>
                ...
                <form onSubmit={handleRegistration}>
                    <div className='px-36 py-4 flex gap-16 '>
                        ...
                        <div className="login-right-container w-1/2 h-full py-12 px-16 flex flex-col items-start bg-gray-50 shadow-2xl rounded-xl">
                            <h2 className='text-xl w-full text-center font-semibold mb-8 font-inter text-whistler-blue'>User Registration</h2>
                            <div className='flex gap-4'>
                                <div className='w-1/2'>
                                    <label className="login-text1 text-sm font-medium mb-1 font-inter text-whistler-blue">First Name</label>
                                    <input
                                        type="text"
                                        className=" bg-gray-200 p-4 pl-6 w-full rounded mb-4  focus:outline-whistler-green"
                                ...
                                <div className='w-1/2'>
                                    <label className="login-text1 text-sm font-medium mb-1 font-inter text-whistler-blue">Last Name</label>
                                    <input
                                        type="text"
                                        className=" bg-gray-200 p-4 pl-6 w-full rounded mb-4  focus:outline-whistler-green"
                            ...
                            <div className="flex justify-between w-full">
                                ...
                                <div className="right">
                                    <Link to={"/partnerlogin"}><a className="login-text2 blue text-sm cursor-pointer hover:text-whistler-green text-whistler-blue">Are You a Partner? Login here</a></Link>
                                </div>
                            </div>
